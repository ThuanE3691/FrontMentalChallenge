...
const CommentBox = () => {
	return (
		<section className="grid md:grid-rows-[auto_auto] grid-rows-[auto_auto_auto] grid-cols-[auto_repeat(3,1fr)] md:w-[723px] bg-white rounded-xl px-6 py-5 gap-x-4 gap-y-4">
			<div className="flex-row self-start col-span-1 row-start-3 px-3 py-2 md:px-3 md:py-4 md:col-span-1 md:row-span-2 md:flex-col flex__center bg-comments-page-Very-light-gray rounded-xl">
				<svg
					width="11"
					height="11"
					className="md:mb-4 md:mr-0 mr-4 transition-colors duration-200 cursor-pointer fill-current text-[#C5C6EF] hover:text-comments-page-Moderate-blue"
				>
				...
				<p className="mr-4 font-medium md:mb-4 md:mr-0 text-comments-page-Moderate-blue">
					12
				</p>
				<svg
					width="11"
			...
			<header className="flex items-center col-span-4 md:col-span-2">
				<img src={amyrobson} alt="" className="w-8 h-8 mr-4" />
